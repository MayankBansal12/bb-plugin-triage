...
const ICON_MAP = {
  // Brand marks for agent providers and model families. These are logos, not
  // affordance icons: the board draws them at full contrast so a card's agent
  // is recognizable before its label is read.
  BrandClaude: ClaudeIcon,
  BrandCopilot: CopilotIcon,
  BrandDeepseek: DeepseekIcon,
  BrandGemini: GoogleGeminiIcon,
  BrandGrok: Grok02Icon,
  BrandMeta: MetaIcon,
  BrandMistral: MistralIcon,
  BrandOpenAi: ChatGptIcon,
  BrandPerplexity: PerplexityAiIcon,
  BrandQwen: QwenIcon,
